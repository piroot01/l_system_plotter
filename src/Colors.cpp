...
const Color Colors::PastelRed = { 255, 179, 186 };
const Color Colors::PastelYellow = { 255, 255, 186 };
...
const Color Colors::PastelBlue = { 186, 255, 255 };
const Color Colors::PastelOrange = { 255, 223, 186 };
const Color Colors::PastelBlack = { 83, 75, 79 };
const Color Colors::PastelGreen = { 186, 255, 201 };
